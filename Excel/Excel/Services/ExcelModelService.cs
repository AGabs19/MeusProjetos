...
{
    public class ExcelModelService : IExcelModelService
    {
        private readonly ExcelContext _conexao;

        public ExcelModelService(ExcelContext conexao)
        {
            _conexao = conexao;
        }
        private Stream AbrirExcel(IFormFile arquivo) ///private Stream AbrirExcel
        {
            ...
            var planilhaExcel = new ExcelMapper(arquivo.OpenReadStream()).Fetch<ExcelModelService>(); //Usando o Excel Mapper
